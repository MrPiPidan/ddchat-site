...
const translations = {
  "zh-Hans": {
    ...
    "connectionsBody": "选择预设服务商，或填入自己的 API 地址和密钥，自动获取模型列表。DDchat 会识别模型的思考、图片理解和工具能力，匹配对应选项。",
    ...
    "htmlExtra": "完整 HTML 网页也能预览与分享。支持公式、流程图、Markdown 排版，以及代码高亮与复制。",
    ...
    "assistantsBody": "写作、编程，或是一个有自己性格的角色。启用助手工具后，一句话即可让 AI 创建助手，或优化已有助手的提示词与配置。每个助手单独保存对话记录。",
    ...
    "faqDeviceAnswer": "支持 iPhone 和 iPad，需要 iOS 26.0 或 iPadOS 26.0 及以上版本。应用内提供简体中文、繁體中文、English、日本語和 한국어。",
    ...
    "downloadBody": "iOS 26.0 及以上版本，需自备 API 密钥。",
    "footerPrivacy": "隐私政策",
    "contact": "联系我们",
  ...
  "zh-Hant": {
    ...
    "connectionsBody": "選擇預設服務商，或填入自己的 API 位址與金鑰，自動取得模型清單。DDchat 會辨識模型的思考、圖片理解與工具能力，配對對應選項。",
    ...
    "htmlExtra": "完整 HTML 網頁也能預覽與分享。支援公式、流程圖、Markdown 排版，以及程式碼醒目提示與複製。",
    ...
    "assistantsBody": "寫作、程式設計，或是一個有自己性格的角色。啟用助手工具後，一句話即可讓 AI 建立助手，或最佳化現有助手的提示詞與設定。每個助手獨立儲存對話記錄。",
    ...
    "faqDeviceAnswer": "支援 iPhone 和 iPad，需要 iOS 26.0 或 iPadOS 26.0 及以上版本。應用程式內提供簡體中文、繁體中文、English、日本語和 한국어。",
    "faqCapabilityQuestion": "支援聯網搜尋與圖片理解嗎？",
    "faqCapabilityAnswer": "支援。可傳送多張圖片，也可讓模型搜尋、讀取網頁並在回答中標註來源。具體能力取決於所選模型與服務商，聯網搜尋也可單獨設定搜尋服務。",
    "downloadTitle": "在 iPhone 和 iPad 上\n使用 DDchat",
    "downloadBody": "iOS 26.0 及以上版本，需自備 API 金鑰。",
    "footerPrivacy": "隱私政策",
    "contact": "聯絡我們",
  ...
  "en": {
    ...
    "connectionsBody": "Choose a preset provider or enter your own API URL and key to fetch models. DDchat identifies reasoning, vision, and tool capabilities and shows the relevant options.",
    ...
    "htmlExtra": "Preview and share full HTML pages, too. Render math, diagrams, and Markdown, with syntax highlighting and code copying.",
    ...
    "assistantsBody": "For writing, coding, or a character of your own. Enable assistant tools, then ask AI to create an assistant or refine its prompts and settings in one sentence. Each assistant keeps its own conversations.",
    ...
    "faqDeviceAnswer": "iPhone and iPad running iOS 26.0 or iPadOS 26.0 or later. The app is available in Simplified Chinese, Traditional Chinese, English, Japanese, and Korean.",
    ...
    "downloadBody": "Requires iOS 26.0 or later and your own API key.",
  ...
  "ja": {
    ...
    "connectionsBody": "プリセットのプロバイダーを選ぶか、API URL とキーを入力してモデルを取得。DDchat が推論・画像理解・ツールの対応状況を識別し、適切な設定を表示します。",
    ...
    "htmlExtra": "HTML ページ全体のプレビューと共有にも対応。数式、図表、Markdown に加え、コードのハイライトとコピーも使えます。",
    ...
    "assistantsBody": "文章作成、プログラミング、個性のあるキャラクターにも。助手ツールを有効にすれば、ひと言で AI に助手の作成や既存のプロンプト・設定の改善を頼めます。会話履歴は助手ごとに保存します。",
    ...
    "faqDeviceAnswer": "iOS 26.0 または iPadOS 26.0 以降の iPhone と iPad に対応しています。アプリの言語は、簡体字中国語、繁体字中国語、英語、日本語、韓国語から選べます。",
    ...
    "downloadBody": "iOS 26.0 以降に対応。ご自身の API キーが必要です。",
  ...
  "ko": {
    ...
    "connectionsBody": "기본 제공 업체를 선택하거나 API 주소와 키를 입력해 모델 목록을 불러오세요. DDchat이 추론, 이미지 이해, 도구 지원 여부를 파악해 필요한 옵션을 표시합니다.",
    ...
    "htmlExtra": "전체 HTML 웹페이지를 미리 보고 공유할 수도 있습니다. 수식, 다이어그램, Markdown과 코드 강조 표시 및 복사를 지원합니다.",
    ...
    "assistantsBody": "글쓰기, 코딩, 개성 있는 캐릭터까지. 도우미 도구를 켜면 한 문장으로 AI에게 도우미 생성이나 기존 프롬프트와 설정 개선을 요청할 수 있습니다. 대화 기록은 도우미별로 저장됩니다.",
    ...
    "faqDeviceAnswer": "iOS 26.0 또는 iPadOS 26.0 이상을 사용하는 iPhone과 iPad를 지원합니다. 앱은 중국어 간체, 중국어 번체, 영어, 일본어, 한국어로 이용할 수 있습니다.",
    ...
    "downloadBody": "iOS 26.0 이상과 개인 API 키가 필요합니다.",
